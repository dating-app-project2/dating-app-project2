    ...
    <div>
      ...
      <div className={imageAndRegister}>
        <div
          className={mainImage}
          style={{
            background: `url(https://images.unsplash.com/photo-1485031828708-859c036d5a5a?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80`,
